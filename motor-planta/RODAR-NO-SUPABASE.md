...
| 5 | Abrir no sistema | Planilha de vendas do Megaleite 2027 → botão **Mapa** (rota `/mapa-vendas/<id da edição>`) | 159 estandes cinza (livres); marcar um `x` na planilha pinta o estande de verde na hora |
