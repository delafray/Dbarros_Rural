...
// Cores das badges de probabilidade moraram aqui até 07/2026; agora vivem em
// utils/probabilidadeCores.ts (apresentação não pertence ao service).
export { probBgColor, probTextColor } from '../utils/probabilidadeCores';
