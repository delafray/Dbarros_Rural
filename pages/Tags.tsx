                    ...
                    {tags
                      ...
                      .map(tag => (
                        <div key={tag.id} className="group flex items-center bg-white text-slate-700 pr-1.5 pl-2 py-1 rounded-lg border border-slate-200 shadow-sm hover:border-blue-300 transition-all">
                          ...
                          {user?.canManageTags && (
                            <div className="flex items-center gap-1 ml-0.5 border-l border-slate-100 pl-1 opacity-0 group-hover:opacity-100 transition-opacity">
                              <button
                                onClick={() => {
                                  setEditingTag({ ...tag });
                                ...
                                title="Editar"
                              >
                                <svg className="w-2.5 h-2.5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z" /></svg>
                              </button>
                              <button
