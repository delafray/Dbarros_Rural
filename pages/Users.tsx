...
import { TempUserModal } from '../components/users/TempUserModal';
import type { EdicaoAtiva } from '../components/users/types';
...
const Users: React.FC = () => {
    ...
    const [edicoesAtivas, setEdicoesAtivas] = useState<EdicaoAtiva[]>([]);
    ...
    useEffect(() => {
        ...
        supabase
            ...
            .order('titulo')
            .then(({ data }) => setEdicoesAtivas((data as EdicaoAtiva[]) || []));
    }, []);
        ...
        <Layout title="Gerenciamento de Usuários">
            <div className="mb-6 flex flex-col sm:flex-row justify-between sm:items-center gap-4">
                ...
                <div className="flex gap-2 w-full sm:w-auto flex-wrap">
                    <Button variant="outline" className="flex-1 sm:flex-none justify-center px-3 py-2 text-[10px] sm:text-xs" onClick={() => setShowTempModal(true)}>
                        Gerar Temp.
                    </Button>
