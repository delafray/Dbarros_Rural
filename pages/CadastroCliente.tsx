            ...
            <div className="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden min-h-[70vh]">
                ...
                <div className="p-6">
                    ...
                    {activeTab === 'contratos' && (
                        <div className="animate-in fade-in duration-300">
                            <div className="flex justify-between items-center mb-6">
                                <h3 className="text-sm font-bold text-slate-800">Contratos Vigentes</h3>
                                <button
                                    className="bg-blue-600 text-white hover:bg-blue-700 hover:shadow-md hover:shadow-blue-500/20 px-4 py-2 rounded-lg text-sm font-bold transition-all flex items-center gap-2"
                                >
                                    <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M12 4v16m8-8H4" /></svg>
                                    Vincular Contrato
                                </button>
                            ...
                            <div className="bg-slate-50 border border-slate-200 rounded-xl p-8 text-center flex flex-col items-center">
                                ...
                                <h4 className="text-base font-bold text-slate-800 mb-1">Módulo de Contratos</h4>
                                <p className="text-sm text-slate-500 max-w-sm mb-6">A gestão de contratos e aditivos conectados a este cliente aparecerá aqui futuramente.</p>
                            </div>
                        </div>
                    )}
